        ...
        child: Column(
          children: <Widget>[
            ...
            ListTile(
              ...
              title: const Text('moises.souza@al.infnet.edu.br', style: TextStyle(fontSize: 18)),
              onTap: () => _launchUrl('mailto:moises.souza@al.infnet.edu.br'), // Email atualizado
            ),
            ListTile(
              leading: const Icon(Icons.phone, color: Colors.blueGrey),
              title: const Text('+55 (21) 99190-1488', style: TextStyle(fontSize: 18)),
              onTap: () => _launchUrl('tel:+5521991901488'), // Telefone atualizado
            ),
            ListTile(
